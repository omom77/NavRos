...
#ifndef SERIAL_MOTOR_DEMO_MSGS__SRV__DETAIL__RUN_MOTOR__FUNCTIONS_H_
#define SERIAL_MOTOR_DEMO_MSGS__SRV__DETAIL__RUN_MOTOR__FUNCTIONS_H_
...
/// Initialize srv/RunMotor message.
/**
...
/// Create srv/RunMotor message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * serial_motor_demo_msgs__srv__RunMotor_Request__init().
...
/// Destroy srv/RunMotor message.
/**
 * It calls
 * serial_motor_demo_msgs__srv__RunMotor_Request__fini()
...
/// Check for srv/RunMotor message equality.
/**
...
/// Initialize array of srv/RunMotor messages.
/**
...
/// Finalize array of srv/RunMotor messages.
/**
 * It calls
 * serial_motor_demo_msgs__srv__RunMotor_Request__fini()
...
/// Create array of srv/RunMotor messages.
/**
 * It allocates the memory for the array and calls
 * serial_motor_demo_msgs__srv__RunMotor_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RunMotor messages.
/**
 * It calls
 * serial_motor_demo_msgs__srv__RunMotor_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RunMotor message array equality.
/**
...
/// Copy an array of srv/RunMotor messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * serial_motor_demo_msgs__srv__RunMotor_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_serial_motor_demo_msgs
...
/**
 * It calls
 * serial_motor_demo_msgs__srv__RunMotor_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_serial_motor_demo_msgs
...
/**
 * It allocates the memory for the array and calls
 * serial_motor_demo_msgs__srv__RunMotor_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_serial_motor_demo_msgs
...
/**
 * It calls
 * serial_motor_demo_msgs__srv__RunMotor_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERIAL_MOTOR_DEMO_MSGS__SRV__DETAIL__RUN_MOTOR__FUNCTIONS_H_
