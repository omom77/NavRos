...
static const _FeedbackMotor_type_support_symbol_names_t _FeedbackMotor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serial_motor_demo_msgs, msg, FeedbackMotor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serial_motor_demo_msgs, msg, FeedbackMotor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serial_motor_demo_msgs, msg, FeedbackMotor)() {
  return &::serial_motor_demo_msgs::msg::rosidl_typesupport_c::FeedbackMotor_message_type_support_handle;
}
